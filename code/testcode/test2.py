...
kukaId = p.loadURDF("franka_panda/model_description/panda.urdf", [0, 0, 0])
...
ll = [-2.8973, -1.7628, -2.8973, -3.0718, -2.8973, -1.6573, -2.8973]
#upper limits for null space
ul = [2.8973, 1.7628, 2.8973, -0.4, 2.8973, 2.1127, 2.8973]
#
# #joint ranges for null space
jr = [5.8, 4, 5.8, 4, 5.8, 4, 6]
#
